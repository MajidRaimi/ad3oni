...
export const platforms: Platform[] = [
  ...
  },
  {
    ...
    description:
      "ادعُ البوت إلى سيرفرك ليصل أعضاءك دعاءُ اليوم تلقائيًا، مع تذكيراتٍ بأوقاتٍ تحدّدها، وتفاعلٍ بزرّ آمين.",
    href: "https://discord.com/oauth2/authorize?client_id=1159198588782518292&permissions=84992&scope=bot+applications.commands",
    cta: "أضِف البوت لسيرفرك",
    status: "live",
    icon: DiscordIcon,
    steps: [
      "ادعُ البوت إلى سيرفرك بنقرة واحدة",
      "اختر القناة ووقت التذكير — يوميًا أو بأوقاتٍ تحدّدها بكلماتك",
      "يصل الدعاء لأعضائك ويتفاعلون بزرّ آمين",
    ],
    features: [
      "دعاء اليوم تلقائيًا",
      "تذكير بأوقاتٍ تحدّدها",
      "جدولة مرنة بكلماتك",
      "زرّ آمين للتفاعل",
      "أدعية حسب الفئة",
      "بحث ومشاركة الأدعية",
